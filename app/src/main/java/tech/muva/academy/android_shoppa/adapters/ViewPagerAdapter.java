...
import tech.muva.academy.android_shoppa.ui.activities.FullscreenActivity;
...
//        imageView.setImageResource(images[position]);
        Glide.with(context).load(images[position]).placeholder(R.drawable.ic_add_shopping_cart)
                .into(imageView);
